...
import KeyboardCellTest from "./Cell-Test";

interface KeyboardGridTestProps {
...
const KeyboardGridTest: React.FC<KeyboardGridTestProps> = ({
  onTextUpdate,
  variant = "gridLayout",
  content = "single",
  doesTap = false,
...
export default KeyboardGridTest;
